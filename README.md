...
6. User Interface: Created a simple user interface for interacting with the system.

** All the function we covered in the file named key_generation.py.
** Testing: wrote comprehensive unit tests for each functionality using a testing framework like unittest. it all contains in - unittest.py file.
